    ...
    <div className=" my-20 max-w-[1215px] max-lg:px-5 mx-auto">
      ...
      <div className=" grid lg:grid-cols-5 gap-y-10 sm:gap-20">
        ...
        <div className="lg:col-span-2 text-base text-gray-500 space-y-10">
          ...
          <p className="" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
          ...
          <div className=" font-[700] space-y-5" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" >
        ...
        <div className=" lg:col-span-3">
          {/* form wrapper  */}
          <div className=" space-y-8" data-aos="fade-up" data-aos-offset="200" data-aos-duration="1200" data-aos-once="true">
            {/* name wrapper  */}
