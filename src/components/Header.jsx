  ...
  return (
    <>
      <nav
        ...
        } sticky top-0  transition-all duration-300 max-w-[1215px] px-5 lg:mx-auto `}
      >
        <div
          className={` sticky top-0 z-50 flex items-center justify-between py-5 bg-white`}
        >
          <div>
            <img
          ...
          <div className=" max-lg:hidden">
            <ul className="flex items-center gap-10">
              ...
              <li>
                <a
                  href="#"
                  className=" text-sm font-[500] flex items-center group"
                >
                  Book a call{" "}
                  <img
          ...
          <ul className="flex flex-col gap-10 ">
            <li>
              <a
                href="#"
                onClick={() => setMenuOpen(!menuOpen)}
                className=" text-sm font-[500] hover:text-gray-500"
              >
                Home
              </a>
            </li>
