  ...
  return (
    <div id="home" className="max-w-[1215px] px-5 mx-auto">
      ...
      <div className="w-[800px] mx-auto lg:w-[650px] mb-[100px] lg:mb-0">
        <h1  data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="100" className="text-title_sm md:text-hero_title font-[700] tracking-tighter mb-8 ">
        ...
        <p data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="200" className="max-w-[600px] text-base_sm md:text-base font-[500] mb-10 text-gray-500 tracking-tight">
          Hi! I’m Jake, a frontend developer based in Yangon,Myanmar. I create
          user-friendly interfaces for fast-growing startups.
        </p>
        <div data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="300" className="flex flex-col  md:flex-row items-start md:items-center gap-5 ps-2">
      ...
      <div data-aos="zoom-out" data-aos-duration="1000" data-aos-once="true" data-aos-delay="100" className="mx-auto">
        <img
