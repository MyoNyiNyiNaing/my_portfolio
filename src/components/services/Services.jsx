...
const Services = () => {
  ...
  return (
    <div id="services"  className="max-w-[1215px] px-5 md:mx-auto flex flex-col justify-center">
      <div className=" text-center" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="100">
